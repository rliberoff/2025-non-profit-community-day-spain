---
applyTo: '**/*.cs'
description: "Programming rules designed to help writting cleaner, more maintainable, and more object-oriented code."
---

# Object Calisthenics Rules and Instructions
...
First Class Collections : une classe qui contient comme attribut un tableau ne doit contenir aucun autre attribut
    ...
    public class GroupUserCollection {
        ...
        public GroupUserCollection(List<User> users) {
            this.users = users;
        }
...
7. **Keep entities small (Class, method, namespace or package)**:
   ...
   - Each class should have a single responsibility and be as small as possible. Contraints:
